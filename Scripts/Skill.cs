            ...
            public void SkillSet(Player player)
            {
                switch ((int)player.Job)
                {
                    case 1:
                        ...
                        Skill dwarfSkill2 = new StatSkill("난쟁이의 포효", "난쟁이가 울부짖습니다.", 5, 1, 10, 3, "버프", "치명타율");
                    ...
                    case 2:
                        ...
                        Skill newSisterSkill2 = new StatSkill("새언니의 울음", "새언니가 울부짖습니다.", 3, 1, 10, 3, "디버프", "공격력");
                        player.Playerskill.Add(newSisterSkill1);
                        player.Playerskill.Add(newSisterSkill2);
                        break;
                    case 3:
                        Skill saisonSkill1 = new AttackSkill("하인의 빗자루 쓸기", "하인이 빗자루로 후려칩니다.", 10, 2, 10, 3);
                        Skill saisonSkill2 = new StatSkill("하인의 청소", "하인이 깔끔하게 청소합니다.", 5, 1, 10, 3, "버프", "회피율");
                        player.Playerskill.Add(saisonSkill1);
                        player.Playerskill.Add(saisonSkill2);
                        break;
                    case 4:
                        Skill OctopusWitch1 = new AttackSkill("마녀의 불마법", "마녀가 불을 쏩니다.", 12, 2, 10, 3);
                        Skill OctopusWitch2 = new StatSkill("마녀의 회복마법", "마녀가 체력을 회복합니다.", 30, 1, 10, 3, "버프", "체력");
                        Skill OctopusWitch3 = new StatSkill("마녀의 저주", "마녀가 저주를 겁니다.", 3, 1, 10, 3, "디버프", "방어력");
                        player.Playerskill.Add(OctopusWitch1);
                        player.Playerskill.Add(OctopusWitch2);
                        player.Playerskill.Add(OctopusWitch3);
                        break;
                    case 5:
                        Skill WildAnimal1 = new AttackSkill("\"야수\"", "야수는 사람을 찢습니다.", 30, 1, 10, 3);
                        Skill WildAnimal2 = new AttackSkill("야수의 울음", "야수가 울부짖습니다.", 15, 2, 10, 3);
